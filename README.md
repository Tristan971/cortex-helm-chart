...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | memcached(memcached) | 6.0.5 |
| https://charts.bitnami.com/bitnami | memcached-index-read(memcached) | 6.0.5 |
| https://charts.bitnami.com/bitnami | memcached-index-write(memcached) | 6.0.5 |
| https://charts.bitnami.com/bitnami | memcached-frontend(memcached) | 6.0.5 |
| https://charts.bitnami.com/bitnami | memcached-blocks-index(memcached) | 6.0.5 |
| https://charts.bitnami.com/bitnami | memcached-blocks(memcached) | 6.0.5 |
| https://charts.bitnami.com/bitnami | memcached-blocks-metadata(memcached) | 6.0.5 |
